...
Kết quả hiện tại với synthetic small graph:
...
CPU baseline: 1000 nodes, 5000 edges, 16 iterations, `0.14562590000059572s`, rank sum `1.0`.

Benchmark harness: CPU row chạy thành công; GPU rows `v1`, `v2`, `v3_pull`, `v3_push` được ghi là `skipped: no cuda` vì Numba CUDA không khả dụng trong môi trường hiện tại.
